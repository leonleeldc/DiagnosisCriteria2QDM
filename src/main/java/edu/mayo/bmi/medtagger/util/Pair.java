...
//		System.out.println(numArr[0].getFirst()+" "+numArr[0].getSecond()+" "+numArr[1].getFirst()+" "+numArr[1].getSecond()+" "
//				+(numArr[0].getFirst()==numArr[1].getFirst())+" "+(numArr[0].getSecond()==numArr[1].getSecond()));
        
        System.out.println("is numArr[0] equal numArr[1]: "+numArr[0].equals(numArr[1]));

        System.out.println("is numArr[0] equal numArr[0]: "+CompIntPair.spanCompare(numArr[0], numArr[0]));
        System.out.println("is numArr[0] subset of numArr[1]: "+CompIntPair.spanCompare(numArr[0], numArr[1]));
        System.out.println("does numArr[1] subsume numArr[0]: "+CompIntPair.spanCompare(numArr[1], numArr[0]));
