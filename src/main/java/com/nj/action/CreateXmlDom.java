...
public class CreateXmlDom {
    ...
    private static Node getCompany(Document doc, String id, String name, String age, String role) {
        ...
        company.appendChild(getCompanyElements(doc, "Name", name));
        company.appendChild(getCompanyElements(doc, "Type", age));
        company.appendChild(getCompanyElements(doc, "Employees", role));
        return company;
    }
